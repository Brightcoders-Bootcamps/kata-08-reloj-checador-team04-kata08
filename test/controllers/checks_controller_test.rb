...
class ChecksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create check" do
    assert_difference('Check.count') do
      post checks_url, params: { check: { privatenumber: @check.privatenumber, type_move: @check.type_move } }
    end
  ...
  test "should update check" do
    patch check_url(@check), params: { check: { privatenumber: @check.privatenumber, type_move: @check.type_move } }
